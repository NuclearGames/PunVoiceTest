...
namespace Utilities.Extensions {
    internal static class ObjectExtensions {
        ...
        /// <summary>
        /// Активирует объект из перечисления под индексом, и деактивирует все остальные 
        /// </summary>
        internal static void SetActive(this IEnumerable<GameObject> gameObjects, int activeIndex) {
            int index = 0;
            gameObjects.ForEach(obj => obj.SetActive(index++ == activeIndex));
        }
        
        /// <summary>
        /// Активирует объект из перечисления под индексом, и деактивирует все остальные 
        /// </summary>
        internal static void SetActive<T>(this IEnumerable<T> gameObjects, int activeIndex) where T : ILabilized {
            int index = 0;
            gameObjects.ForEach(obj => obj.SetActive(index++ == activeIndex));
        }
